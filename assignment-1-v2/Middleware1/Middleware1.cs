...
public class Form1 : Form
{
    ...
    private const int MY_ID = 1;
    private const int MY_PORT = 8082;
    private const int MY_CONTROL_PORT = 8087;
    ...
    // --- Network listener (messages from the network program) ---
    ...
    private async void ReadMessageAsync(TcpClient client)
    {
        ...
        // Parse "Msg #N from Middleware X" -> senderId=X, msgId="MWX#N"
    ...
    private async void SendButton_Click(object sender, EventArgs e)
    {
        ...
        // Initialise proposal tracker before sending (proposals may arrive fast)
